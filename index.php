	...
	<div id="inner">
		...
		<section>
			...
			<article>
				...
				<p>Si besoin, vous pouvez vous référer au plan du site et aux mentions légales accessibles en bas de page.</p>
				<p>Enfin un formulaire de contact est à votre disposition.</p>
			</article>
			...
			<aside>
				...
				<p>Ce site est donc une vitrine, que j'espère la plus agréable et intéressante possible !</p>
				<h2>Me retrouver</h2>
				<ul>
					...
					<li><a href="http://instagram.com/sophiefradiere">Mes photographies sur Instagram</a></li>
				</ul>
			</aside>
